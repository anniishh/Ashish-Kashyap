            ...
            <div className="relative w-full h-[400px] sm:h-[350px] cursor-pointer" onClick={() => setIsFlipped(!isFlipped)}>
              <AnimatePresence initial={false} mode="wait">
                {!isFlipped ? (
                  ...
                  >
                    <div className="w-full h-full border border-sky-100 rounded-2xl shadow-sm hover:shadow-md transition-shadow relative overflow-hidden bg-white">
                      {/* Background decorations */}
                      <div className="absolute top-0 right-0 w-48 h-48 bg-sky-50 rounded-full opacity-70 translate-x-1/2 -translate-y-1/2"></div>
                      <div className="absolute bottom-0 left-0 w-64 h-64 bg-sky-50 rounded-full opacity-70 -translate-x-1/2 translate-y-1/2"></div>
                      
                      <div className="relative z-10 flex flex-col h-full">
                        <div className="bg-sky-500 p-4 border-b-4 border-sky-200">
                          <div className="flex items-center gap-4">
                            ...
                            <div className="text-white">
                              ...
                              <p className="text-sky-100 font-semibold text-sm">Official Identity Credential</p>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="p-6 grid grid-cols-1 sm:grid-cols-2 gap-x-6 gap-y-4 flex-grow bg-white/40 backdrop-blur-sm">
                        <div className="bg-white/80 p-3 rounded-lg border border-sky-100">
                          <p className="text-xs text-sky-600 uppercase font-bold mb-1 tracking-wider">ID Number</p>
                          <p className="text-slate-800 font-mono font-bold">JKQT/IH24/73380</p>
                        </div>
                        <div className="bg-white/80 p-3 rounded-lg border border-sky-100">
                          <p className="text-xs text-sky-600 uppercase font-bold mb-1 tracking-wider">UID Number</p>
                          <p className="text-slate-800 font-mono font-bold">17KTQSZIH1897</p>
                        </div>
                        <div className="bg-white/80 p-3 rounded-lg border border-sky-100">
                          <p className="text-xs text-sky-600 uppercase font-bold mb-1 tracking-wider">Jurisdiction / Location</p>
                          <p className="text-slate-800 font-bold">Haryana (All India)</p>
                        </div>
                        <div className="bg-white/80 p-3 rounded-lg border border-sky-100 flex flex-col justify-center items-start">
                          <p className="text-xs text-sky-600 uppercase font-bold mb-1 tracking-wider">Validity Status</p>
                          <div className="flex items-center gap-2">
                            <span className="inline-block bg-sky-500 text-white shadow-sm text-xs px-2.5 py-1 rounded font-bold uppercase">Lifetime</span>
                  ...
                  <motion.div
                    ...
                    className="absolute inset-0 w-full h-full [backface-visibility:hidden]"
                  >
                    <div className="w-full h-full border border-sky-100 rounded-2xl shadow-sm hover:shadow-md transition-shadow relative overflow-hidden flex flex-col bg-white">
                      <div className="bg-sky-500 text-white py-3 px-6 text-center shadow-md">
                        <h4 className="font-bold text-sm md:text-base uppercase tracking-wider drop-shadow-md">Terms & Conditions</h4>
                      </div>
                      
                      <div className="p-6 flex-grow flex flex-col justify-between overflow-y-auto bg-sky-50/30 backdrop-blur-sm">
                        <ul className="text-xs md:text-[13px] text-slate-700 space-y-2.5 list-decimal list-inside pl-1 marker:text-sky-500 marker:font-bold font-medium">
                      ...
                      <div className="bg-sky-900 text-white p-4 md:p-5 text-center mt-auto border-t-4 border-sky-400">
                        <h5 className="font-bold text-sm mb-2 text-sky-200 uppercase tracking-widest">Office Address</h5>
                        <p className="text-xs text-white/90 leading-relaxed font-medium">
                          ...
                          <span className="text-sky-200 mt-1 inline-block">www.ihrccc.com | info@ihrccc.com</span><br />
                          <span className="text-sky-300">Ph.: 9333333121, 8388888851</span>
                        </p>
                      </div>
                    </div>
                  </motion.div>
