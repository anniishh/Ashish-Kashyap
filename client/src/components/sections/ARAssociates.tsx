        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start mb-20">
          <div className="lg:col-span-8 space-y-8">
            <div className="flex flex-col sm:flex-row items-center sm:items-center gap-4 md:gap-6 mb-6">
              <div className="bg-white p-3 rounded-2xl shadow-sm border border-black/5 inline-block shrink-0">
                <img src={logo} alt="A.R. & Associates Logo" className="h-20 sm:h-24 md:h-28 lg:h-32 object-contain" />
              </div>
              <div className="flex flex-col text-center sm:text-left">
                ...
                <p className="text-black/70 text-sm sm:text-base md:text-[16px] leading-relaxed max-w-3xl mt-1">
